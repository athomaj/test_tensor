...
#define OBJECT_TRACKER_METHOD(METHOD_NAME) \
  Java_owl_com_testtensor_ObjectTracker##METHOD_NAME  // NOLINT
...
extern "C" {
JNIEXPORT
void JNICALL Java_owl_com_testtensor_ObjectTracker_initNative(JNIEnv* env, jobject thiz,
                                               jint width, jint height,
                                               jboolean always_track);

JNIEXPORT
void JNICALL Java_owl_com_testtensor_ObjectTracker_releaseMemoryNative(JNIEnv* env,
                                                        jobject thiz);

JNIEXPORT
void JNICALL Java_owl_com_testtensor_ObjectTracker_registerNewObjectWithAppearanceNative(
    JNIEnv* env, jobject thiz, jstring object_id, jfloat x1, jfloat y1,
    jfloat x2, jfloat y2, jbyteArray frame_data);

JNIEXPORT
void JNICALL Java_owl_com_testtensor_ObjectTracker_setPreviousPositionNative(
    JNIEnv* env, jobject thiz, jstring object_id, jfloat x1, jfloat y1,
    jfloat x2, jfloat y2, jlong timestamp);

JNIEXPORT
void JNICALL Java_owl_com_testtensor_ObjectTracker_setCurrentPositionNative(
    JNIEnv* env, jobject thiz, jstring object_id, jfloat x1, jfloat y1,
    jfloat x2, jfloat y2);

JNIEXPORT
jboolean JNICALL Java_owl_com_testtensor_ObjectTracker_haveObject(JNIEnv* env, jobject thiz,
                                                   jstring object_id);

JNIEXPORT
jboolean JNICALL Java_owl_com_testtensor_ObjectTracker_isObjectVisible(JNIEnv* env,
                                                        jobject thiz,
                                                        jstring object_id);

JNIEXPORT
jstring JNICALL Java_owl_com_testtensor_ObjectTracker_getModelIdNative(JNIEnv* env,
                                                        jobject thiz,
                                                        jstring object_id);

JNIEXPORT
jfloat JNICALL Java_owl_com_testtensor_ObjectTracker_getCurrentCorrelation(JNIEnv* env,
                                                            jobject thiz,
                                                            jstring object_id);

JNIEXPORT
jfloat JNICALL Java_owl_com_testtensor_ObjectTracker_getMatchScore(JNIEnv* env, jobject thiz,
                                                    jstring object_id);

JNIEXPORT
void JNICALL Java_owl_com_testtensor_ObjectTracker_getTrackedPositionNative(
    JNIEnv* env, jobject thiz, jstring object_id, jfloatArray rect_array);

JNIEXPORT
void JNICALL Java_owl_com_testtensor_ObjectTracker_nextFrameNative(JNIEnv* env, jobject thiz,
                                                    jbyteArray y_data,
                                                    jbyteArray uv_data,
                                                    jlong timestamp,
...
JNIEXPORT
void JNICALL Java_owl_com_testtensor_ObjectTracker_forgetNative(JNIEnv* env, jobject thiz,
                                                 jstring object_id);

JNIEXPORT
jbyteArray Java_owl_com_testtensor_ObjectTracker_getKeypointsPacked(
    JNIEnv* env, jobject thiz, jfloat scale_factor);

JNIEXPORT
jfloatArray Java_owl_com_testtensor_ObjectTracker_getKeypointsNative(
    JNIEnv* env, jobject thiz, jboolean only_found_);

JNIEXPORT
void JNICALL Java_owl_com_testtensor_ObjectTracker_getCurrentPositionNative(
    JNIEnv* env, jobject thiz, jlong timestamp, jfloat position_x1,
    jfloat position_y1, jfloat position_x2, jfloat position_y2,
    jfloatArray delta);

JNIEXPORT
void JNICALL Java_owl_com_testtensor_ObjectTracker_drawNative(JNIEnv* env, jobject obj,
                                               jint view_width,
                                               jint view_height,
                                               jfloatArray delta);

JNIEXPORT void JNICALL Java_owl_com_testtensor_ObjectTracker_downsampleImageNative(
...
JNIEXPORT
jfloatArray JNICALL Java_owl_com_testtensor_ObjectTracker_getKeypointsNative(
...
JNIEXPORT
jbyteArray JNICALL Java_owl_com_testtensor_ObjectTracker_getKeypointsPacked(
    JNIEnv* env, jobject thiz, jfloat scale_factor) {
...
JNIEXPORT
void JNICALL Java_owl_com_testtensor_ObjectTracker_drawNative(
